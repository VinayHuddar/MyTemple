package com.mytemple.androidapp.FindPujari.View.PujariProfile;
...
import com.mytemple.androidapp.Common.View.SlidingTabLayout;
import com.mytemple.androidapp.FindPujari.Model.PujaList;
import com.mytemple.androidapp.FindPujari.Model.PujariProfile;
import com.mytemple.androidapp.R;

/**
 * Created by vinayhuddar on 12/09/15.
 */
public class PujariProfileScreen extends AppCompatActivity implements PujariProfile.Callback, PujaList.Callback, ImageDownloader.Callback {
    ...
    public static class PujaListFragment extends Fragment {
        ...
        public class PujaGridAdapter extends BaseAdapter {
            ...
            public View getView (int position, View convertView, ViewGroup parent) {
                ...
                ImageView pujaImage = (ImageView)currView.findViewById(R.id.Icon);
