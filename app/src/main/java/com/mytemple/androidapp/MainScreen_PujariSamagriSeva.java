...
import com.mytemple.androidapp.FindPujari.View.PujariListing.PujariListingScreen;


public class MainScreen_PujariSamagriSeva extends BaseActivity implements NavigationDrawerCallbacks {
    Activity mActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Temple");
